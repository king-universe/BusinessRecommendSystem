...
public class Configure {
    ...
    public Jedis getRedisClient() {
        ...
        sentines.add("192.168.8.247:26379");
        sentines.add("192.168.8.180:26379");
        GenericObjectPoolConfig conf = new JedisPoolConfig();
        conf.setMaxTotal(20);
        conf.setMaxIdle(20);
        JedisSentinelPool sentinelPool = new JedisSentinelPool("master", sentines, conf, 100, "123456", 3);
        conf.setMaxIdle(20);
        conf.setMaxTotal(20);
